...
Original file is located at
    https://colab.research.google.com/drive/1Nwf5e4n4sysswS-oB84pEmdqs9kyHoD0
"""
...
if __name__ == "__main__":
    ...
    plaintext = "Hello, World! Hello Dudu and Bubu!!!"
    ...
    # Write plaintext to a text file
    ...
    print(f"Encrypted: {[hex(e) for e in encrypted_ints]}")
